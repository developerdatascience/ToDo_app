...
Revision ID: 5e11aca49e21
Revises: ed299979ec2e
Create Date: 2025-08-03 12:22:31.731207
...
revision: str = '5e11aca49e21'
down_revision: Union[str, None] = 'ed299979ec2e'
...
def upgrade() -> None:
    ...
    op.drop_table('users')
    op.drop_index(op.f('ix_addTask_id'), table_name='addTask')
    op.drop_index(op.f('ix_addTask_title'), table_name='addTask')
...
def downgrade() -> None:
    ...
    op.create_index(op.f('ix_addTask_title'), 'addTask', ['title'], unique=False)
    op.create_index(op.f('ix_addTask_id'), 'addTask', ['id'], unique=False)
